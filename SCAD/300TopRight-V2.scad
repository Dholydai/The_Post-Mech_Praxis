// Generated by SolidPython 1.1.3 on 2024-01-04 15:04:19
$fn = 32;
					...
					difference() {
						...
						union() {
							translate(v = [0, 0, -34.0000000000]) {
								translate(v = [-59.5312500000, 0, 0]) {
									translate(v = [0, -140.8350000000, 0]) {
										cube(size = [347.6625000000, 55.1200000000, 68]);
									}
								}
							}
							translate(v = [0, 0, -34.0000000000]) {
