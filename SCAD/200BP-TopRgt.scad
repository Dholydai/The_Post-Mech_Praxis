// Generated by SolidPython 1.1.3 on 2023-12-27 01:43:16
$fn = 32;
...
difference() {
	...
	translate(v = [0, 0, 4.3890000000]) {
		translate(v = [183.8312500000, 0, 0]) {
			translate(v = [0, 151.8250000000, 0]) {
				cube(center = true, size = [20, 6.0000000000, 11]);
			}
		}
	}
	translate(v = [0, 0, 16.4445000000]) {
